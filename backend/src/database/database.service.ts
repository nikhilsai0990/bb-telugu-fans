...
export class DatabaseService implements OnModuleInit {
  ...
  public seedInitialData() {
    ...
    // Leaders: Blue Team Leader = Debjani Modak, Red Team Leader = Rohit Naidu.
    // HIGH RISK ZONE (3): Aman, Sudheer Kumar Reddy, and Varshini Sounderajan.
    ...
    const contestantsList: Contestant[] = [
      {
        ...
        bio: "Red Team Leader and Task Winner, navigating the house with strategic composure and athletic leadership.",
      ...
      },
      {
        ...
        bio: "Athletic model and fitness athlete currently in the High Risk Zone as an active nominated housemate.",
      ...
      },
      {
        ...
        bio: "Bold digital model voicing unfiltered perspectives as an active housemate.",
      ...
      // --- BLUE HOUSEMATES ---
      {
        ...
        bio: "Celebrated Jabardasth punchline king and Task Winner, competing as an active nominated housemate.",
      ...
      },
      {
        ...
        bio: "Digital creator and voice of 'Sudheer Talks' currently in the High Risk Zone as an active nominated housemate.",
      ...
      },
      {
        ...
        bio: "Spirited television host with sharp verbal clarity and charisma currently in the High Risk Zone as an active nominated housemate.",
      ...
      },
      {
        ...
        bio: "Blue Team Leader and graceful television serial actress leading her squad with determination.",
        occupation: "Television Actress",
        status: "NOMINATED",
        isActive: true,
        isNominated: true,
    ...
    // Contains EXACTLY the 14 active nominated housemates (Charan and Chaitra Rai are ELIMINATED and excluded).
    ...
    const pollSave: Poll = {
      ...
      description: "14 active housemates are currently nominated! Voting is currently closed.",
    ...
    // 4. Official Season 10 News Dispatches (5 Required Stories)
