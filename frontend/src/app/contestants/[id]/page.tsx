    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 space-y-10">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div className="editorial-card rounded-lg p-5 space-y-1">
          ...
          <p className={`font-display text-2xl sm:text-3xl ${isEliminated ? "text-red-400" : "text-emerald-400"} leading-none`}>
        ...
        <div className="editorial-card rounded-lg p-5 space-y-1">
          ...
          <span className="text-[10px] text-zinc-500 uppercase">
            {isEliminated ? "Eliminated Housemate" : "Week 1 Housemate"}
          </span>
        </div>
