...
export const fallbackContestants: Contestant[] = [
  ...
  },
  {
    ...
    bio: "Athletic model and fitness standout currently in the High Risk Zone as an active nominated housemate.",
...
// Fallback Poll — ONLY "WHO SHOULD BE SAVED?" with 14 active nominated housemates (Charan and Chaitra Rai excluded)
