  ...
  const features = [
    {
      ...
      description: "Cryptographically protected polling capturing audience sentiment across all 16 nominated housemates.",
      icon: Vote,
      href: "/polls",
    },
    {
      ...
      description: "Complete profiles of all 16 contestants across Red and Blue factions, leadership records, and arena standings.",
      icon: TrendingUp,
      href: "/contestants",
    },
    {
      ...
      description: "Immediate reporting on mass nominations, task resolutions, and crucial house status announcements.",
      icon: Newspaper,
      href: "/news",
    },
    {
      ...
      description: "High-level debates analyzing team tactics, leadership decisions, and week-by-week voting trajectories.",
      icon: MessageSquare,
      href: "/discuss",
    },
    {
